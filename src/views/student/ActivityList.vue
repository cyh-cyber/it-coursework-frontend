            ...
            <el-card class="activity-card shadow-hover" :body-style="{ padding: '0px' }">
              ...
              <div class="card-content">
                ...
                <div class="card-footer">
                  ...
                  <el-button v-if="activity.is_registered" type="danger" size="small" @click="cancelRegistration(activity.id)">Cancel</el-button>
                  <el-button v-else type="primary" size="small" @click="register(activity.id)">Register</el-button>
                </div>
              </div>
            </el-card>
          </el-col>
